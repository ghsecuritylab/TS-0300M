...
status_t HAL_AudCodecInit(HAL_AudCodecType_EN type){
	...
	DRIVER_DELAY(5);
//	HAL_AudCodecWrite(audCodec,0x01, 0x0AD);//HAL_AudCodecWrite(audCodec,0x01, 0x03D);
//	HAL_AudCodecWrite(audCodec,0x02, 0x03F);//HAL_AudCodecWrite(audCodec,0x02, 0x1BF);
//	HAL_AudCodecWrite(audCodec,0x03, 0x103);//HAL_AudCodecWrite(audCodec,0x03, 0x04F);
...
//	HAL_AudCodecWrite(audCodec,0x0E, 0x008);//HAL_AudCodecWrite(audCodec,0x0E, 0x108);
//	HAL_AudCodecWrite(audCodec,0x0F, 0x1FF);
//	HAL_AudCodecWrite(audCodec,0x2C, 0x001);//HAL_AudCodecWrite(audCodec,0x2C, 0x003);
//	HAL_AudCodecWrite(audCodec,0x2F, 0x050);//HAL_AudCodecWrite(audCodec,0x2F, 0x055);
//	HAL_AudCodecWrite(audCodec,0x30, 0x000);//HAL_AudCodecWrite(audCodec,0x30, 0x055);
//	HAL_AudCodecWrite(audCodec,0x31, 0x002);//HAL_AudCodecWrite(audCodec,0x31, 0x062);
