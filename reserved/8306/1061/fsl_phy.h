...
#define PHY_CONTROL1_REG 0x16U          /*!< The PHY control one register. */
#define PHY_CONTROL2_REG 0x18U          /*!< The PHY control two register. */

#define PHY_CONTROL_ID1 0x1CU /*!< The PHY ID1*/
...
/*!
 * @brief Pretreatment Initializes PHY.
 *
 *  This function initialize the SMI interface and Pretreatment initialize PHY (before unlink up).
 *
 * @param base       ENET peripheral base address.
 * @param phyAddr    The PHY address.
 * @param srcClock_Hz  The module clock frequency - system clock for MII management interface - SMI.
...
/*!
 * @brief PHY check auto negotiation 
 *
 *
 * @param base       ENET peripheral base address.
 * @param phyAddr    The PHY address.
 * @retval true  PHY check auto negotiation complete
 * @retval false  PHY check auto negotiation fail
 */
