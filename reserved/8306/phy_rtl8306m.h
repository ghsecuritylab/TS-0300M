...
/** @brief Dump all RTL8306M PHY SMI configuration registers
 *
...
/** @brief Default RTL8306M phy_check_init function.
 */
void phy_rtl8306m_check_phy_init(void);

/** @brief Default RTL8306M phy_get_speed_mode function.
 */
eth_speed_mode_t phy_rtl8306m_get_speed_mode(void);

/** @brief Default RTL8306M phy_get_duplex_mode function.
 */
eth_duplex_mode_t phy_rtl8306m_get_duplex_mode(void);

/** @brief Default RTL8306M phy_power_enable function.
 *
 ...
 */
void phy_rtl8306m_power_enable(bool);

/** @brief Default RTL8306M phy_init function.
 */
void phy_rtl8306m_init(void);

/** @brief Default RTL8306M PHY configuration
 *
 ...
 * Consult the Ethernet example to see how this is done.
 */
extern const eth_config_t phy_rtl8306m_default_ethernet_config;
