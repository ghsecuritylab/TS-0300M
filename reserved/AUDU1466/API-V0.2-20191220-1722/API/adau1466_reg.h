...
/* usb_in  */
#define REG_DSP2_USB_IN_ADDR                           (REG_DSP2_LINE_IN_1_ADDR + 4) 

/* dante_in  */
#define REG_DSP2_DANTE_IN_ADDR                           (REG_DSP2_LINE_IN_1_ADDR + 5) 
...
/* usb_out  for all in */
#define REG_DSP2_USB_OUT_ADDR                          (REG_DSP2_LINE_IN_1_ADDR + 11) 

/* dante_out  for all in */
#define REG_DSP2_DANTE_OUT_ADDR                          (REG_DSP2_LINE_IN_1_ADDR + 12) 
...
/* line_out_1_5 for usb_in */
#define REG_DSP2_LINE_OUT_1_USB_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 19) 

/* line_out_1_6 for dante_in */
#define REG_DSP2_LINE_OUT_1_DANTE_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 20) 
...
/* line_out_2_5 for usb_in */
#define REG_DSP2_LINE_OUT_2_USB_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 28) 

/* line_out_2_6 for dante_in */
#define REG_DSP2_LINE_OUT_2_DANTE_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 29) 
...
#define REG_DSP2_USB_OUT_LINE1_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 33) 

/* usb_out_l_2 for line_in_2 */
#define REG_DSP2_USB_OUT_LINE2_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 34) 

/* usb_out_l_3 for line_in_3 */
#define REG_DSP2_USB_OUT_LINE3_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 35) 

/* usb_out_l_4 for line_in_4 */
#define REG_DSP2_USB_OUT_LINE4_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 36) 

/* usb_out_l_5 for usb_in */
#define REG_DSP2_USB_OUT_USB_ADDR                     (REG_DSP2_LINE_IN_1_ADDR + 37) 

/* usb_out_l_6 for dante_in */
#define REG_DSP2_USB_OUT_DANTE_ADDR                     (REG_DSP2_LINE_IN_1_ADDR + 38) 

/* usb_out_l_7 for dante_in_l */
#define REG_DSP2_USB_OUT_DANTEL_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 39) 

/* usb_out_l_8 for dante_in_r */
#define REG_DSP2_USB_OUT_DANTER_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 40) 

/* usb_out_l_9 for wire_wifi_mic_mixer_in */
#define REG_DSP2_USB_OUT_ALL_MIC_MIX_ADDR              (REG_DSP2_LINE_IN_1_ADDR + 41) 

/* usb_out_r_1 for line_in_1 */
#define REG_DSP2_DANTE_OUT_LINE1_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 42) 

/* usb_out_r_2 for line_in_2 */
#define REG_DSP2_DANTE_OUT_LINE2_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 43) 

/* usb_out_r_3 for line_in_3 */
#define REG_DSP2_DANTE_OUT_LINE3_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 44) 

/* usb_out_r_4 for line_in_4 */
#define REG_DSP2_DANTE_OUT_LINE4_ADDR                    (REG_DSP2_LINE_IN_1_ADDR + 45) 

/* usb_out_r_5 for usb_in */
#define REG_DSP2_DANTE_OUT_USB_ADDR                     (REG_DSP2_LINE_IN_1_ADDR + 46) 

/* usb_out_r_6 for dante_in */
#define REG_DSP2_DANTE_OUT_DANTE_ADDR                     (REG_DSP2_LINE_IN_1_ADDR + 47) 

/* usb_out_r_7 for dante_in_l */
#define REG_DSP2_DANTE_OUT_DANTEL_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 48) 

/* usb_out_r_8 for dante_in_r */
#define REG_DSP2_DANTE_OUT_DANTER_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 49) 

/* usb_out_r_9 for wire_wifi_mic_mixer_in */
#define REG_DSP2_DANTE_OUT_ALL_MIC_MIX_ADDR              (REG_DSP2_LINE_IN_1_ADDR + 50) 
...
/* dante_out_l_5 for usb_in */
#define REG_DSP2_DANTE_OUT_L_USB_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 55) 

/* dante_out_l_6 for dante_in */
#define REG_DSP2_DANTE_OUT_L_DANTE_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 56) 
...
/* dante_out_r_5 for usb_in */
#define REG_DSP2_DANTE_OUT_R_USB_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 64) 

/* dante_out_r_6 for dante_in */
#define REG_DSP2_DANTE_OUT_R_DANTE_ADDR                   (REG_DSP2_LINE_IN_1_ADDR + 65) 
...
/* usb_in  mute */
#define REG_DSP2_USB_IN_MUTE_ADDR 	          (REG_DSP2_LINE_IN_1_MUTE_ADDR+4)

/* dante_in  mute */
#define REG_DSP2_DANTE_IN_MUTE_ADDR 	          (REG_DSP2_LINE_IN_1_MUTE_ADDR+5)
...
/* usb_in single */
#define REG_DSP2_USB_IN_SINGLE_ADDR              (REG_DSP2_LINE_IN_1_SINGLE_ADDR +4)

/* dante_in single */
#define REG_DSP2_DANTE_IN_SINGLE_ADDR              (REG_DSP2_LINE_IN_1_SINGLE_ADDR +5)
...
/* usb_out   mute */
#define REG_DSP2_USB_OUT_MUTE_ADDR               (REG_DSP2_LINE_OUT_1_MUTE_ADDR+2)

/* dante_out   mute */
#define REG_DSP2_DANTE_OUT_MUTE_ADDR               (REG_DSP2_LINE_OUT_1_MUTE_ADDR+3)
...
/* usb_out single */
#define REG_DSP2_USB_OUT_SINGLE_ADDR              (REG_DSP2_LINE_OUT_1_SINGLE_ADDR +2)

/* dante_out single */
#define REG_DSP2_DANTE_OUT_SINGLE_ADDR              (REG_DSP2_LINE_OUT_1_SINGLE_ADDR +3)
...
/* usb_in */
#define REG_DSP1_USB_IN_ADDR                            (REG_DSP1_WIRE_IN_1_ADDR + 18)

/* dante_in */
#define REG_DSP1_DANTE_IN_ADDR                            (REG_DSP1_WIRE_IN_1_ADDR + 19)
...
/* channel_out_1 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_1_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 60)

/* channel_out_1 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_1_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 61)
...
/* channel_out_2 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_2_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 82)

/* channel_out_2 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_2_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 83)
...
/* channel_out_3 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_3_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 104)

/* channel_out_3 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_3_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 105)
...
/* channel_out_4 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_4_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 126)

/* channel_out_4 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_4_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 127)
...
/* channel_out_5 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_5_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 148)

/* channel_out_5 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_5_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 149)
...
/* channel_out_6 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_6_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 170)

/* channel_out_6 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_6_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 171)
...
/* channel_out_7 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_7_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 192)

/* channel_out_7 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_7_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 193)
...
/* channel_out_8 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_8_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 214)

/* channel_out_8 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_8_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 215)
...
/* channel_out_9 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_9_USB_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 236)

/* channel_out_9 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_9_DANTE_ADDR                  (REG_DSP1_WIRE_IN_1_ADDR + 237)
...
/* channel_out_10 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_10_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 258)

/* channel_out_10 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_10_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 259)
...
/* channel_out_11 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_11_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 280)

/* channel_out_11 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_11_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 281)
...
/* channel_out_12 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_12_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 302)

/* channel_out_12 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_12_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 303)
...
/* channel_out_13 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_13_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 324)

/* channel_out_13 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_13_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 325)
...
/* channel_out_14 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_14_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 346)

/* channel_out_14 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_14_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 347)
...
/* channel_out_15 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_15_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 368)

/* channel_out_15 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_15_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 369)
...
/* channel_out_16 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_16_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 390)

/* channel_out_16 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_16_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 391)
...
/* channel_out_mixer_to_si for usb_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_SI_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 412)

/* channel_out_mixer_to_si for dante_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_SI_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 413)
...
/* channel_out_mixer_to_dsp2 for usb_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_DSP2_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 434)

/* channel_out_mixer_to_dsp2 for dante_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_DSP2_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 435)
...
/* channel_out_mixer_to_wifi for usb_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_WIFI_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 456)

/* channel_out_mixer_to_wifi for dante_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_WIFI_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 457)
...
/* channel_out_mixer_to_wire for usb_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_WIRE_USB_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 478)

/* channel_out_mixer_to_wire for dante_in  */
#define REG_DSP1_CHANNEL_OUT_MIXER_TO_WIRE_DANTE_ADDR                 (REG_DSP1_WIRE_IN_1_ADDR + 479)
