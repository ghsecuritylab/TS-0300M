...
/*!
 * @brief Get Instance.(add by KT 20191121)
 * 
 */
...
/*!
 * @brief Set the ethernet specific interrupt.
 *
 * This function is used for set ethernet irq enable/disable.
 *
 * @param base  ENET peripheral base address.
 * @param interrupt The IRQ number.
 * @param interrupt enable or disable.
 */
